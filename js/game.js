...
/**
 * Adds an event listener to the window for the detectDevice function on resize.
 */
function initDetect() {
...
/**
 * Detects the device and its orientation. Opens automatically the fullscreen mode.
 */
detectDevice = () => {
    let detectObj = {
